...
namespace GameSdk.Core.Loggers
{
    ...
    public class SystemLog
    {
        ...
        public static void Log(string tag, Func<string> messageFn)
            => Logger.Log(LogType.Log, tag, messageFn);
        ...
        /// <param name="tag">Tag of the message.</param>
        /// <param name="messageFn">Function that returns the message to log.</param>
        public static void LogWarning(string tag, Func<string> messageFn)
            => Logger.Log(LogType.Warning, tag, messageFn);
        ...
        /// <param name="tag">Tag of the message.</param>
        /// <param name="messageFn">Function that returns the message to log.</param>
        public static void LogError(string tag, Func<string> messageFn)
            => Logger.Log(LogType.Error, tag, messageFn);
        ...
        /// <param name="args">Arguments to format the message with.</param>
        public static void LogFormat(LogType logType, string tag, Func<string> formatFn, params object[] args) =>
            Logger.LogFormat(logType, tag, formatFn, args);
        ...
        /// <param name="tag">Tag of the message.</param>
        /// <param name="messageFn">Function that returns the message to log.</param>
        public static void Log(LogType logType, string tag, Func<string> messageFn)
            => Logger.Log(logType, tag, messageFn);
    }
}
